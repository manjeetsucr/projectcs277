...
// Then is will be a good demonstrator of the potential architectures and required features to deliver a good performance for such
// code patterns
...
static void get_time_and_accumulate(perfcounter_t *accumulate_cycles, perfcounter_t *last_cycles)
{
